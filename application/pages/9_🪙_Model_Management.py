...
def main():
    ...
    if st.session_state.new_model:
        ...
        model_type_list = ["Sagemaker", "Bedrock API", "Other API"]
        ...
        if model_type == "Sagemaker":
            ...
            if st.button('Add Connection', type='primary'):
                if sagemaker_name == '':
                    ...
                    ModelManagement.add_sagemaker_model(model_id="sagemaker." + sagemaker_name, model_region=sagemaker_region,
            ...
            if st.button('Add Connection', type='primary'):
                if api_model_name == '':
                    ...
                    ModelManagement.add_api_model(model_id="bedrock-api." + api_model_name, api_url=api_url,
                                                  api_header=api_header, input_payload=input_payload, output_format=output_format)
        ...
        elif model_type == "Other API":
            st.write("Please contact the administrator to add the API model")
        ...
        if model_type == "Sagemaker":
            ...
            if st.button('Update Model Connection', type='primary'):
                if sagemaker_name.startswith("bedrock-api."):
                    sagemaker_name = sagemaker_name[10:]
